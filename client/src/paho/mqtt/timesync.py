...
def multiple(client_id="", hostname="localhost", port=1883, keepalive=60,
             will=None, auth=None, tls=None, protocol=paho.MQTTv5,
             transport="tcp", proxy_args=None):
    """Request time multiple messages to a broker, then disconnect cleanly.
...
def single(client_id="", qos=0, retain=False, hostname="localhost",
           port=1883, keepalive=60, will=None, auth=None,
           tls=None, protocol=paho.MQTTv5, transport="tcp", proxy_args=None):
    """Request time packet send to a broker, then disconnect cleanly.
    ...
    multiple(client_id, hostname, port, keepalive, will, auth, tls,
